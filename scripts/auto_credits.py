...
for mod in mods_list:
    with open("../plus/mods/" + mod, "rb") as mod_file:
        ...
        mod_meta_data = json.loads(requests.get("https://staging-api.modrinth.com/v2/project/" + mod_file_data.get("update").get("modrinth").get("mod-id")).text)
        mod_user_data = json.loads(requests.get("https://staging-api.modrinth.com/v2/project/" + mod_file_data.get("update").get("modrinth").get("mod-id") + "/members").text)
